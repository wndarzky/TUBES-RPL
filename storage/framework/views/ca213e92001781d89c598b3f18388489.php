<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">
            <?php echo e(__('Edit :edit', ['edit' => __('Payment Vendor')])); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            <label class="form-label" for="edit_account_number"><?php echo e(__('Account Number')); ?> <span
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/payment-vendor/edit-modal.blade.php ENDPATH**/ ?>