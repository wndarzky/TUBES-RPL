<div>
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-body">
                <?php echo $__env->make('printout.preview.revenue', [
                    'data' => $data,
                    'year' => $year,
                    'period' => $period,
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/report/revenue/preview.blade.php ENDPATH**/ ?>