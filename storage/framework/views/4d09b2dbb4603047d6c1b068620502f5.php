...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" wire:model='title'
                placeholder="<?php echo e(__('Package Title')); ?>" wire:loading.attr='disabled' wire:target='image'>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            <label class="form-label" for="price"><?php echo e(__('Price')); ?> <span class="text-danger">(*)</span></label>
            <input type="number" class="form-control" id="price" wire:model='price'
                placeholder="<?php echo e(__('Price')); ?>" wire:loading.attr='disabled' wire:target='image'>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="description" wire:model='description'
                placeholder="<?php echo e(__('Description')); ?>" wire:loading.attr='disabled' wire:target='image'>
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/package/create-modal.blade.php ENDPATH**/ ?>