        ...
        <div class="card">
            <div class="card-body">
                <!--[if BLOCK]><![endif]--><?php if($month != 'all'): ?>
                    <?php echo $__env->make('printout.preview.unit_report', [
                        'data' => $data,
                        'month' => $month,
                        'year' => $year,
                        'period' => $period,
                ...
                <?php else: ?>
                    <?php echo $__env->make('printout.preview.unit_all_report', [
                        'data' => $data,
                        'month' => $month,
                        'period' => $period,
                    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/report/unit/preview.blade.php ENDPATH**/ ?>