<div>
    <!--[if BLOCK]><![endif]--><?php if(empty($month) && empty($year)): ?>
        <?php echo e(__('Please select the period to be displayed.')); ?>
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-body">
                <!--[if BLOCK]><![endif]--><?php if($month != 'all'): ?>
                    <?php echo $__env->make('printout.preview.reservation_report', [
                        'data' => $data,
                        'month' => $month,
                        'year' => $year,
                        'period' => $period,
                ...
                <?php else: ?>
                    <?php echo $__env->make('printout.preview.reservation_all_report', [
                        'data' => $data,
                        'year' => $year,
                        'period' => $period,
                    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/report/reservation/preview.blade.php ENDPATH**/ ?>