<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">
            <?php echo e(__('Edit :edit', ['edit' => __('Unit')])); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="edit_name" wire:model='name'
                placeholder="<?php echo e(__('Unit Name')); ?>">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            <label class="form-label" for="edit_register_number"><?php echo e(__('Register Number')); ?> <span
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['register_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-3">
            <label class="form-label" for="edit_status"><?php echo e(__('Status')); ?></label>
            <select class="form-select" id="edit_status" wire:model='status'>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Enums\UnitType::getValues(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($status); ?>"><?php echo e(__(Str::headline($status))); ?></option>
...
<?php /**PATH C:\TUGAS\atv-ticket-reservation\resources\views/livewire/backend/unit/edit-modal.blade.php ENDPATH**/ ?>